...
Deltat0           = 1e-8;  % Initial time step
...
t_final           = 0.45;  % Final simulation time
...
R_end_percent     = 0.35;       % Final droplet size as a fraction of initial radius (when Save = true)

T_0               = 300;        % Initial temperature at the center of the droplet [K]
T_inf             = 1500;       % Ambient (far-field) temperature [K]

% --------------------------- SPECIES DEFINITION --------------------------

fuel_names        = {'Heptano', 'Hexadecano'};     % Fuel components
mass_fracL        = {0.5, 0.5};                    % Mass fraction of each fuel component (same order as above)
...
% FileName    = 'Saved_solutions5.mat'; % File containing saved variables from previous run
% 
